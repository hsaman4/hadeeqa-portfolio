        ...
        <div className="projects-container" id="projects">
            ...
            <div className="halal-foodies-img">
                ...
                <div className="halal-content">
                    ...
                    <div className="halal-live">
                    </div>
                    <div className="halalsite-links">
                        Github:
                        <a href="https://github.com/hsaman4/halalfood-backend.git">Backend</a> |
                        <a href ="https://github.com/hsaman4/halalfood-react.git">Frontend</a>
                        </div>
                </div>
